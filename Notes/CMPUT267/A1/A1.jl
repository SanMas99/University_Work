...
student = (name="Sanad Masannat", email="sanad@ualberta.ca", ccid="sanad", idnumber=1626221)
...
function mean(X::Vector{Float64})
	...
	for i in eachindex(X)
		totalOfArray=totalOfArray+X[i]
		numOfElements+=1
	end
	return (totalOfArray/numOfElements)
end
...
function var(X::Vector{Float64})
	...
	numOfElements=0
	for i in eachindex(X)
		totalOfArray+=(X[i]-mean(X))^2
		numOfElements+=1
	end
	return (totalOfArray/(numOfElements-1))
end
