...
public class Polygon
{
	...
	public void SetUpPolygon(Vector2[] _points, float _lineWidth, Color _lineColor)
    {
		SetPoints(_points);
    ...
    public void RenderPolygon(GameObject polygonObject, Color color, float _lineWidth)
    {
        for (int i = 0; i < points.Length; i++){
